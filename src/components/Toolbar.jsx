...
const IC = {
  ...
  preview: <Icon><polygon points="5 3 19 12 5 21 5 3"/></Icon>,
}
...
const Toolbar = ({
  ...
  const handleUndo = () => {
    console.log('[Toolbar] Undo button clicked, window.__wbUndo exists:', !!window.__wbUndo)
    window.__wbUndo?.()
  }
  const handleRedo = () => {
    console.log('[Toolbar] Redo button clicked, window.__wbRedo exists:', !!window.__wbRedo)
    window.__wbRedo?.()
  }
